...
enum
{
	COIN_NONE = 0,	// 2P 2・キ・蟀`・ソゥ`ケフカィ (・チ・ァ・テ・ッアリメェ、ハ、キ)
	COIN_2P1C,		// 2P 1・キ・蟀`・ソゥ`
	COIN_2P2C,		// 2P 2・キ・蟀`・ソゥ`
	COIN_3P1C,		// 3P 1・キ・蟀`・ソゥ`
	COIN_3P2C,		// 3P 2・キ・蟀`・ソゥ`
	COIN_3P3C,		// 3P 3・キ・蟀`・ソゥ`
	COIN_4P1C,		// 4P 1・キ・蟀`・ソゥ`
	COIN_4P2C,		// 4P 2・キ・蟀`・ソゥ`
	COIN_4P4C,		// 4P 4・キ・蟀`・ソゥ`
	COIN_MAX
};
