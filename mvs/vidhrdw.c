...
void neogeo_video_init(void)
{
	...
	high_tile_mask |= (no_of_tiles > 0x60000) ? 0x60000 : 0;//ヨァウヨタゥネンCROM
	high_tile_mask |= (no_of_tiles > 0x80000) ? 0x80000 : 0;//ヨァウヨタゥネンCROM
	high_tile_mask |= (no_of_tiles > 0xa0000) ? 0xa0000 : 0;//ヨァウヨタゥネンCROM
	high_tile_mask |= (no_of_tiles > 0xc0000) ? 0xc0000 : 0;//ヨァウヨタゥネンCROM
