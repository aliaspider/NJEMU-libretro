...
/*--------------------------------------------------------
	NEOGEO CDZ・ィ・゜・螂□`・キ・逾□Kチヒ (called by BIOS)
--------------------------------------------------------*/
